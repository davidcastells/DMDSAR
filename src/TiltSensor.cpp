 ...
 */
void TiltSensor::mahonyUpdateIMU(double gx, double gy, double gz, double ax, double ay, double az, double elapsedTime)
{
    double recipNorm;
...
double TiltSensor::invSqrt(double x)
{
 ...
 * @param mz
 */
void TiltSensor::mahonyUpdate(double gx, double gy, double gz, double ax, double ay, double az, double mx, double my, double mz, double elapsedTime)
{
    double recipNorm;
...
void TiltSensor::toEulerAngles(double* roll, double* pitch, double* yaw)
{
